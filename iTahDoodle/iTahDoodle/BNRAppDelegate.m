...
// Helper function to getch the path to our to-do data stored on disk
NSString *BNRDocPath(){
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    // Define the frame rectagle of the three UI elements
    ...
    // Make the BNRAppDelegate the table views datasource
    ...
    //Create and confiure the UITextField instance where new tasks will be entered
...
-(NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section{
    ...
    // the nubmer of rows in it is equal to
    // the number of items in the tasks array
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    // ... and hand the proerply configured cell back to the talbe view
    return c;
}
